...
ArrowTexture::ArrowTexture( Qt3DCore::QNode* parent )
  : QPaintedTextureImage( parent ) {
  setSize( QSize( 512, 512 ) );
}

void ArrowTexture::setSettings( int arrowSize, int arrowWidth, int centerLineSize, int borderLineSize, QColor arrowColor, QColor centerLineColor, QColor borderLineColor, QColor backgroundColor ) {
...
void ArrowTexture::setAnyDirectionArrows( bool anyDirection ) {
...
void ArrowTexture::paint( QPainter* painter ) {
