...
class PointMeshGeometry : public Qt3DRender::QGeometry {
    Q_OBJECT

  public:
    PointMeshGeometry( const QVector<QVector3D>& vertices, Qt3DCore::QNode* parent = Q_NULLPTR );
    ~PointMeshGeometry() = default;
    int vertexCount();
