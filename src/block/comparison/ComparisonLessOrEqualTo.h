...
public:
  explicit ComparisonLessOrEqualTo( const BlockBaseId          idHint,
...
public:
  ComparisonLessOrEqualToFactory( QThread* thread ) : BlockFactory( thread, false ) { typeColor = BlockBase::TypeColor::Arithmetic; }
