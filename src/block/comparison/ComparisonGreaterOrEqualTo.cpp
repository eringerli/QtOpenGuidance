...
void ComparisonGreaterOrEqualTo::emitConfigSignals() {
  Q_EMIT stateChanged( result );
}

void ComparisonGreaterOrEqualTo::setValueA( double number ) {
  numberA = number;
  operation();
}

void ComparisonGreaterOrEqualTo::setValueB( double number ) {
  numberB = number;
  operation();
}

void ComparisonGreaterOrEqualTo::operation() {
  result = numberA >= numberB;
  Q_EMIT stateChanged( result );
}

QNEBlock* ComparisonGreaterOrEqualToFactory::createBlock( QGraphicsScene* scene, int id ) {
