...
void ComparisonGreaterThan::emitConfigSignals() {
  Q_EMIT stateChanged( result );
}

void ComparisonGreaterThan::setValueA( double number ) {
  numberA = number;
  operation();
}

void ComparisonGreaterThan::setValueB( double number ) {
  numberB = number;
  operation();
}

void ComparisonGreaterThan::operation() {
  result = numberA > numberB;
  Q_EMIT stateChanged( result );
}

QNEBlock* ComparisonGreaterThanFactory::createBlock( QGraphicsScene* scene, int id ) {
