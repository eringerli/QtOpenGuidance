...
public:
  explicit CascadedComplementaryFilterImuFusion( const BlockBaseId          idHint,
...
public:
  CascadedComplementaryFilterImuFusionFactory( QThread* thread ) : BlockFactory( thread, false ) {
