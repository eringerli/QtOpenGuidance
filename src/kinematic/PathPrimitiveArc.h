...
class PathPrimitiveArc : public PathPrimitive {
public:
  PathPrimitiveArc() = default;
  PathPrimitiveArc( const Point_2& startPoint,
...
public:
  bool operator==( PathPrimitiveArc& b ) const;
  bool operator==( const PathPrimitiveArc& b ) const;
