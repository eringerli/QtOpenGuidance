...
inline const QVector3D convertPoint2ToQVector3D( const Point_2& point, const float z = 0 ) {
...
inline const Point_3 convertEigenVector3ToPoint3( const Eigen::Vector3d& point ) {
  return Point_3( point.x(), point.y(), point.z() );
}

inline const Point_2 convertEigenVector3ToPoint2( const Eigen::Vector3d& point ) {
...
inline const Eigen::Vector3d toEigenVector( const Point_2& point ) {
